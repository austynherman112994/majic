...
const navigation = [
    ...
    { name: 'Pipelines', href: 'pipelines', icon: UsersIcon, current: false },
...
const teams = [
    { id: 1, name: 'Users', href: '#', initial: 'U', current: false },
]
...
export default function SideNav() {
    return (
        <div className="max-w-64  h-full">
            <div className=" h-full flex grow flex-col gap-y-7 overflow-y-auto px-6 bg-gray-800">
                ...
                <nav className="flex flex-1 flex-col">
                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                                        ...
                                        <a
                                            ...
                                            className={classNames(
                                                item.current
                                                    ...
                                                    : 'text-indigo-200 hover:bg-indigo-400 hover:text-white',
                        ...
                        <li className="-mx-6 mt-auto">
                            <a
                                href="#"
                                className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-white hover:bg-indigo-400"
                            >
